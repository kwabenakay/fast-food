export default function Order() {
  return (
    <div className=" bg-[#FBF3EF]">
      ...
      <div className=" grid grid-cols-2 gap-80 pl-40">
        <div className=" flex flex-col gap-12">
          ...
          <div className=" flex justify-between">
            ...
            <button className=" bg-[#D6C07C] w-24 h-14 rounded-lg font-bold text-xl hover:bg-[#FFE594]">ADD</button>
          </div>
          <div>
            selected items
          </div>
        ...
        <div className=" flex flex-col justify-between w-fit">
          <div className=" bg-white flex flex-col justify-between w-96 min-h-96 p-6">
          ...
          <button className=" bg-[#B29740] w-28 h-14 rounded-lg font-bold text-xl self-end hover:bg-[#FDD65C]">Generate</button>
        </div>
      </div>
    </div>
  );
